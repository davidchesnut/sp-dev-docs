...
|Create an instance of a manager object in the context of a specified user|CSOM: not implementedJSOM: not implementedREST: not implementedSSOM:  [SPSocialFollowingManager](https://msdn.microsoft.com/library/Microsoft.Office.Server.Social.SPSocialFollowingManager.#ctor.aspx) (overloaded)|
