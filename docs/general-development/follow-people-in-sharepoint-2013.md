...
|Create an instance of a manager object in the context of a particular user |<p>CSOM: not implemented</p> <p>JSOM: not implemented</p> <p>REST: not implemented</p> <p>SSOM:  [SPSocialFollowingManager](https://msdn.microsoft.com/library/Microsoft.Office.Server.Social.SPSocialFollowingManager.#ctor.aspx) (overloaded)</p>|
